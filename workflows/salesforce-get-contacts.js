export default async function (ctx) {
  // Migrated from fastn v1 flow "salesforceGetContacts".
  // v1 ran a SOQL contacts query on the Salesforce connector; v2 reads the unified
  // entity crm/contact (ue_604ae4985d2b) with provider "salesforce".
  ...
  try {
    ...
    if (cursor && msg.includes("UNIFIED_CURSOR_INVALID")) {
      ...
      return { options: [], searchable: true }; // nothing connected yet
    } else if (
