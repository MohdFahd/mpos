export default async function (ctx) {
  // Migrated from fastn v1 flow "salesforceGetOpportunities".
  // v1 ran a SOQL opportunities query on the Salesforce connector; v2 reads the
  // unified entity crm/opportunity (ue_c89f86935426) with provider "salesforce".
